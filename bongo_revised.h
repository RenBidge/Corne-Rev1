#define ANIM_FRAME_DURATION_BONGO 75 // how long each frame lasts in ms
#define ANIM_SIZE_BONGO 636 // number of bytes in array, minimize for adequate firmware size, max is 1024
...
static const char PROGMEM idle_minimal[] = {
...
static const char PROGMEM prep_minimal[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static const char PROGMEM tap_minimal[TAP_FRAMES][ANIM_SIZE_BONGO] = {
    {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static void draw_bongo(void)
{
    ...
    {
        case Idle:
            oled_write_raw_P(idle_minimal, ANIM_SIZE_BONGO);
            break;

        case Prep:
            oled_write_raw_P(prep_minimal, ANIM_SIZE_BONGO);
            break;

        case Tap:
            oled_write_raw_P(tap_minimal[abs((TAP_FRAMES - 1) - current_tap_frame)], ANIM_SIZE_BONGO);
